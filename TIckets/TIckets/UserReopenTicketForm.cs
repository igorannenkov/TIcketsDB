...
{
    public partial class UserReopenTicketForm : Form
    {
        public UserReopenTicketForm()
        {
            InitializeComponent();
        }
        private void userReopenTicketFormCnlBtn_Click(object sender, EventArgs e)
        {
            this.Close();
        }
        private void userReopenTicketFormBtn_Click(object sender, EventArgs e)
        {
